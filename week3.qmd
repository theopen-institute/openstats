...
model1a <- cmdstan_model("models/wb_model1a.stan", dir=".stancache")
fit1a <- df |>
  transmute(
...
model1b <- cmdstan_model("models/wb_model1b.stan", dir=".stancache")
fit1b <- df |>
  transmute(
    fertility_rate = SP.DYN.TFRT.IN,
...
model2 <- cmdstan_model("models/wb_model2.stan", dir=".stancache")
fit2 <- df |>
  transmute(
    fertility_rate = SP.DYN.TFRT.IN,
    women_in_college = scale(SE.TER.ENRR.FE) |> as.numeric(),
