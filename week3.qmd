...
<!-- TODO: This whole unit needs to be fundamentally reimagined. Start with the problem, then find the solution. -->
...
<table>
  <thead>
    <tr>
      <td data-id="leftmargin1"></td>
      <td data-id="rightmargin1">Success</td>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td data-id="leftmargin2">Normal&nbsp;Surgeon</td>
      <td data-id="rightmargin2">[89.6%]{.green}</td>
    </tr>
    <tr>
      <td data-id="leftmargin3">Famous&nbsp;Surgeon</td>
      <td data-id="rightmargin3">[74.9%]{.red  }</td>
    </tr>
  </tbody>
</table>
:::
...
<table>
  <thead>
    <tr>
      ...
      <td>Complex</td>
      <td>Critical</td>
      <td  data-id="rightmargin1" style="border-left: 1px solid black;">Total</td>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>[66.0%]{.red  }</td>
      <td>[38.0%]{.red  }</td>
      <td data-id="rightmargin2" style="border-left: 1px solid black;">[89.6%]{.green}</td>
    </tr>
    <tr>
      <td data-id="leftmargin3">Famous&nbsp;Surgeon</td>
      <td>[99.7%]{.green}</td>
      <td>[75.0%]{.green}</td>
      <td>[50.0%]{.green}</td>
      <td data-id="rightmargin3" style="border-left: 1px solid black;">[74.9%]{.red  }</td>
    </tr>
  </tbody>
</table>
:::
...
# Generative Model Demo {.no-title}

```{shinylive-r}
#| standalone: true
{{< include shiny/regression.R >}}
``` 
