---
title: "Week 1: Statistics is just observation"
...
- We are going to scrap all of this jargon to rebuild statistics from the ground up.
...
- P( rain ) = 179 / 365 = 0.49 (49%) [<br>(This is just counting.)]{.fragment} 
...
- P( rain | Apr) = 13/30 = 0.43 (43%)
- P( rain | Dec) = 0/31 = 0.00 (0%)
- P( rain | Jul ) = 31/31 = 1.00 (100%)
- P( rain | Feb ) = 2/28 = 0.07 (7%)
:::
...
> A result is statistically significant if, [assuming the null hypothesis is true]{.fragment fragment-index=2 .highlight-current-red} and the model assumptions hold, [the probability of obtaining data at least as extreme as those observed]{.fragment fragment-index=3 .highlight-current-red} (the p-value) is less than or equal to the chosen significance level α. This leads to rejection of the null hypothesis while controlling the long-run Type I error rate at α.
...
<!-- TODO: Clean this one up a lot -->

- We are thinking about statistics backwards.
- If statistics has ever made you feel dumb or intimidated, it's not about you.
