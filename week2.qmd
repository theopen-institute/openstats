...
Three components of statistical questions:
...
- Tomorrow, either the sun will rise or it won't. These are the only two possibilities, thus there is a 50/50 chance.
- Come join my weekly poker game!
...
<!-- TODO: Come up with some kind of demo of generative processes -->
...
- Our job is to describe how that randomness occurs.
...
- Given a particular parameter value, how likely is the data we saw?
  - If our parameter is _actually_ 50%, what is the probability of seeing 4 out of 15?
  - If our parameter is _actually_ 30%, what is the probability of seeing 4 out of 15?
  - If our parameter is _actually_ 80%, what is the probability of seeing 4 out of 15?

::: {.fragment}
This is a well-understood question that a calculator can answer.
:::
